...
import { UpdateAircraftEffects } from './ngrx/update-aircraft/update.effect';
...
@NgModule({
  ...
  imports: [
    ...
    EffectsModule.forRoot([AircraftsEffects,LoginEffects,UpdateAircraftEffects]),               //spécifier les effects
